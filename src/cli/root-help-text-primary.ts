export const ROOT_HELP_TEXT_PRIMARY = [
  ...
  "  tab profile extension list   List a profile's unpacked extensions",
  '  tab profile extension add    Load an unpacked extension into a profile',
  '  tab profile extension rm     Unload an extension from a profile',
  "  tab profile extension reload Re-read a profile's extensions from disk",
